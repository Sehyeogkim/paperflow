...
# When generating HTML visualizations, diagrams, or any styled output, use the Anthropic/Claude brand color palette:
- Background: #F0EEE6 (warm cream/beige)
- Primary accent: #CC785C (Claude Orange / terracotta)
